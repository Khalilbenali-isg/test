...
import { Container, VStack, Heading, Box, Input, Text, Flex } from '@chakra-ui/react';
...
const CreatePage = () => {
  ...
  console.log("User data loaded successfully:", token);
  useEffect(() => {
    if (!loggedInUser) {
    ...
    console.log("User ID:", loggedInUser?.image);
